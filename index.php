...
<head>
    ...
    <title><?php echo APP_NAME; ?> — Notion Canvas OS</title>
...
<body class="bg-[#070a13] text-slate-100 min-h-screen flex antialiased selection:bg-blue-500 selection:text-white">
